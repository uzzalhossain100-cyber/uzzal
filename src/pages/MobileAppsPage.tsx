...
import { 
  ...
  Sparkles, CheckCircle2, ShieldCheck, HelpCircle, Layers
} from 'lucide-react';
...
const MobileAppsPage: React.FC = () => {
  ...
  const handleDownloadApk = () => {
    ...
    // Create and trigger direct APK download for the All-in-One Android WebApp/APK
    const apkUrl = "/downloads/AllInOne-v1.0.0.apk";
    
    // Simulate immediate user feedback & fallback creation
    setTimeout(() => {
      const link = document.createElement('a');
      link.href = apkUrl;
      link.setAttribute('download', 'AllInOne-v1.0.0.apk');
  ...
  return (
    <div className="flex flex-col h-full gap-4 max-w-7xl mx-auto w-full pb-10">
      ...
      <Card className="w-full overflow-hidden bg-gradient-to-br from-purple-900 via-indigo-900 to-slate-900 text-white shadow-2xl border-none rounded-3xl p-6 sm:p-8">
        <div className="grid grid-cols-1 lg:<dyad-write path="src/pages/MobileAppsPage.tsx" description="Mobile Apps Page with 100+ popular apps and APK download section">
"use client";
...
import { 
  Smartphone, ArrowLeft, Search, Download, ExternalLink, Play, 
  CheckCircle2, ShieldCheck, Layers, Sparkles
} from 'lucide-react';
import { popularMobileApps, MobileAppItem } from '@/data/mobileApps';
import { useTranslation } from '@/lib/translations';
import { toast } from 'sonner';
...
const MobileAppsPage: React.FC = () => {
  ...
  const handleDownloadApk = () => {
    ...
    // Create a client-side simulated APK download link or PWA download trigger
    setTimeout(() => {
