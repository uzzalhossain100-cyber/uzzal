...
const AIPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!apiKey) {
      showError("Gemini API Key পাওয়া যায়নি। অনুগ্রহ করে .env ফাইল চেক করুন।");
      return;
    }
  ...
  const handleAskQuestion = async (e: React.FormEvent) => {
    ...
    if (!model.current) {
      showError("এআই মডেল লোড হয়নি। অনুগ্রহ করে পেজ রিফ্রেশ করুন।");
      return;
    }
    ...
    try {
      ...
      const errorMessage: Message = { id: messages.length + 2, sender: 'ai', text: "দুঃখিত, আপনার প্রশ্নের উত্তর দিতে পারিনি। অনুগ্রহ করে আবার চেষ্টা করুন।" };
